        ...
        Api.getMyCompanyInfo({}).then(function (res) {
            ...
            if(res && res.data != null){
                that.setData({
                    ...
                    CompanyTrade: res.data.trade && res.data.trade.split(','),
                    technology: res.data.trade && res.data.technology.split(','),
                    ulabel: res.data.trade && res.data.ulabel.split(','),
                    ...
                    business: res.data.business && res.data.business.split(','),
